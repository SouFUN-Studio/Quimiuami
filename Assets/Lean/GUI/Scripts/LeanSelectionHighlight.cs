...
namespace Lean.Gui
{
	...
	public class LeanSelectionHighlight_Inspector : LeanInspector<LeanSelectionHighlight>
	{
		protected override void DrawInspector()
		{
			...
			Draw("showTransitions", "This allows you to perform a transition when the highlight begins. You can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>. For example, the <b>Graphic.color Transition (LeanGraphicColor)</b> component can be used to change the color.\nNOTE: Any transitions you perform here must be reverted in the <b>Hide Transitions</b> setting using a matching transition component.");
			Draw("hideTransitions", "This allows you to perform a transition when the highlight ends. You can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>. For example, the <b>Graphic.color Transition (LeanGraphicColor)</b> component can be used to change the color.\nNOTE: Any transitions you perform here must be reverted in the <b>Show Transitions</b> setting using a matching transition component.");
