...
namespace Lean.Gui
{
	...
	public class LeanWindowCloser : MonoBehaviour
	{
		...
		/// <summary>If every window is closed and you press the close key, this window will be opened.
		/// This can be used to open an options menu.</summary>
...
namespace Lean.Gui
{
	...
	public class LeanWindowCloser_Inspector : LeanInspector<LeanWindowCloser>
	{
		protected override void DrawInspector()
		{
			...
			Draw("emptyWindow", "If every window is closed and you press the close key, this window will be opened.\nThis can be used to open an options menu.");
