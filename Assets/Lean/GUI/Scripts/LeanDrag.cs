...
namespace Lean.Gui
{
	...
	public class LeanDrag_Editor : LeanInspector<LeanDrag>
	{
		...
		{
			Draw("m_Navigation");
			Draw("target", "If you want a different RectTransform to be moved while dragging on this UI element, then specify it here.\nThis allows you to turn the current UI element into a drag handle.");
