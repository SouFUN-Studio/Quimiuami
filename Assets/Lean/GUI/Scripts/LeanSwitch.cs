...
namespace Lean.Gui
{
	...
	public class LeanSwitch : MonoBehaviour
	{
		...
		/// For example, the <b>Play Sound Transition (LeanPlaySound)</b> component can be used to play a switch sound.</summary>
...
namespace Lean.Gui
{
	...
	public class LeanSwitch_Editor : LeanInspector<LeanSwitch>
	{
		...
		protected override void DrawInspector()
		{
			...
			Draw("changedStateTransitions", "This allows you to perform a transition when this switch changes to a different state.\nYou can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>.\nFor example, the <b>Play Sound Transition (LeanPlaySound)</b> component can be used to play a switch sound.");
