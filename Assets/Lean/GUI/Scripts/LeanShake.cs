...
namespace Lean.Gui
{
	...
	public class LeanShake_Editor : LeanInspector<LeanShake>
	{
		...
		protected override void DrawInspector()
		{
			...
			Draw("strength", "This allows you to set the current strength of the shake. This value can automatically decay based on the <b>Dampening</b> and <b>Reduction</b> settings.");
			Draw("multiplier", "This allows you to set the final shake strength multiplier. This remains constant.");
			Draw("dampening", "This allows you to set the dampening of the <b>Strength</b> value. This decay slows down as it approaches 0.");
			Draw("reduction", "This allows you to set the reduction of the <b>Strength</b> value. This decay slows down at a constant rate per second.");
