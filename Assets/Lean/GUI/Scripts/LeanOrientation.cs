...
namespace Lean.Gui
{
	...
	public class LeanOrientation_Editor : LeanInspector<LeanOrientation>
	{
		protected override void DrawInspector()
		{
			...
			Draw("landscapeTransitions", "This allows you to perform a transition when the orientation changes to landscape.\nYou can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>.\nFor example, the <b>Graphic.color Transition (LeanGraphicColor)</b> component can be used to change the color.\nNOTE: Any transitions you perform here must be reverted in the <b>Portrait Transitions</b> setting using a matching transition component.");
			Draw("portraitTransitions", "This allows you to perform a transition when the orientation changes to portrait.\nYou can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>.\nFor example, the <b>Graphic.color Transition (LeanGraphicColor)</b> component can be used to change the color.\nNOTE: Any transitions you perform here must be reverted in the <b>Landscape Transitions</b> setting using a matching transition component.");
