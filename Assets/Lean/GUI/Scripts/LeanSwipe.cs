...
namespace Lean.Gui
{
	...
	public class LeanSwipe_Editor : LeanInspector<LeanSwipe>
	{
		protected override void DrawInspector()
		{
			...
			Draw("swipeTransitions", "This allows you to perform a transition when you swipe this UI element. You can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>. For example, the <b>Play Sound Transition (LeanPlaySound)</b> component can be used to play a click sound.");
